        ...
        ?>
            ...
            <form action="../controlador/modificar_producto.php" method="POST">
                ...
                <label>
                    ...
                    <input type="text" require="require"  placeholder="Ingrese un nombre..." name="nombre" id="nombre" value="<?php echo $nombre; ?>" />
                </label>
                <br>
                <label>
                    Descripcion: <br>
                    <textarea name="descripcion" require="require"  id="descripcion" placeholder="Ingresa la descripcion..."><?php echo $descripcion; ?></textarea>
                </label>
                <br>
                <label>
                    Valor: <br>
